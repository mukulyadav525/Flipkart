...
export const MOCK_EVAL_METRICS: EvalMetric[] = [
  { violation_type: 'helmet',          precision: '—', recall: '—', f1: '—', n_gt: '0', scene_context_dependent: 'false' },
  { violation_type: 'seatbelt',        precision: '—', recall: '—', f1: '—', n_gt: '0', scene_context_dependent: 'false' },
  { violation_type: 'triple_riding',   precision: '—', recall: '—', f1: '—', n_gt: '0', scene_context_dependent: 'false' },
  { violation_type: 'wrong_side',      precision: '—', recall: '—', f1: '—', n_gt: '0', scene_context_dependent: 'true'  },
  { violation_type: 'stop_line',       precision: '—', recall: '—', f1: '—', n_gt: '0', scene_context_dependent: 'true'  },
  { violation_type: 'red_light',       precision: '—', recall: '—', f1: '—', n_gt: '0', scene_context_dependent: 'true'  },
  { violation_type: 'illegal_parking', precision: '—', recall: '—', f1: '—', n_gt: '0', scene_context_dependent: 'true'  },
]
